 ...
 */
class FieldsComparingSpecificationTest extends NonCompositeSpecificationTestTemplate
{
    public function testBasics()
    {
        $spec = new ColumnsComparingSpecification('c=', 'startDate', 'finishDate');
        $this->assertEquals($spec->getType(), 'c=');
    ...
    public function testConstructorException1()
    {
        ...
        $spec = new ColumnsComparingSpecification('=', 'startDate', 'finishDate');
    }
